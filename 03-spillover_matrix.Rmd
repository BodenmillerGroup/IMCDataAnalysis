...
`prepareSCEfromTXT` function expects a named list, where each name represents
...
# Read txt files
cur_txts_names <- list.files("data/Figure_S5/Spillover_Matrix_2/", full.names = TRUE)
...
```{r debarcoding, message=TRUE, warning=TRUE}
library(CATALYST)
