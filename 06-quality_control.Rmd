...
dittoDimPlot(spe, var = "patient_id", reduction.use = "TSNE")

plotReducedDim(spe, dimred = "UMAP", colour_by = "Ecad", by_exprs_values = "exprs")
plotReducedDim(spe, dimred = "UMAP", colour_by = "CD45RO", by_exprs_values = "exprs")
plotReducedDim(spe, dimred = "TSNE", colour_by = "Ecad", by_exprs_values = "exprs")
```
