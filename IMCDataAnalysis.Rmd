...
<!--chapter:end:03-spillover_matrix.Rmd-->
...
<!--chapter:end:07-classification.Rmd-->

# Visualizing the images

Using the `cytomapper` package.

<!--chapter:end:08-image_visualization.Rmd-->

# Visualizing single-cell data

Using the `dittoSeq` package.

<!--chapter:end:09-data_visualization.Rmd-->
...
<!--chapter:end:10-spatial_analysis.Rmd-->
