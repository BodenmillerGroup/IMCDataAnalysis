...
While visualizing 6 markers on the pixel-level still may still allow the
distinction of different structures and expression levels, we can see that the
distinction of per cell expression levels is difficult when visualizing many markers
