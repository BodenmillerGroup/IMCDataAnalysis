...
The final section addresses how to save composite images and how to get them
returned for integration with other plots.

The `plotPixels` and `plotCells` function accepts the `save_plot` argument which
...
image saved to disk - this only needs to be adjusted for small images.
...
and saved as variable. In the following code chunk we save two example plots
to variables.
