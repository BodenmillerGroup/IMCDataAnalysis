...
* [Seurat](https://github.com/immunogenomics/harmony) version `r packageVersion("Seurat")`
...
download.file("https://zenodo.org/record/6460961/files/steinbock.sh", 
...
url <- "https://zenodo.org/record/6460961/files/intensities.zip"
...
url <- "https://zenodo.org/record/6460961/files/regionprops.zip"
...
# download neighbors
url <- "https://zenodo.org/record/6460961/files/neighbors.zip"
...
# download images
url <- "https://zenodo.org/record/6460961/files/img.zip"
...
# download masks
url <- "https://zenodo.org/record/6460961/files/masks_deepcell.zip"
...
download.file("https://zenodo.org/record/6460961/files/panel.csv", 
              "data/steinbock/panel.csv")
download.file("https://zenodo.org/record/6460961/files/images.csv", 
...
In Section \@ref(classification), we present a cell type classification
approach that relies on previously gated cells. This ground truth data
is available online at 
[TODO](TODO) and will be downloaded here for later use:

```{r download-gated-cells}
download.file("https://zenodo.org/record/5949116/files/gated_cells.zip",
