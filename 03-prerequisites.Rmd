...
download.file("https://zenodo.org/record/5949116/files/sample_metadata.xlsx", 
              destfile = "data/sample_metadata.xlsx", method = "wget")
```
...
unzip(destfile, exdir="data/steinbock", overwrite=TRUE, method = "wget")
unlink(destfile)
...
download.file("https://zenodo.org/record/5949116/files/compensation.zip",
              "data/compensation.zip", method = "wget")
