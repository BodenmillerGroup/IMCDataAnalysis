...
The needed output of the `steinbock` framework includes the single-cell
mean intensity files, the single-cell morphological features and spatial locations,
spatial object graphs in form of edge lists indication cells in close proximity,
hot pixel filtered multi-channel images, segmentation masks, image metadata
and channel metadata. All these files will be downloaded here for easy access.

```{r steinbock-results}
options(timeout=10000)
# download intensities
download.file("https://zenodo.org/record/6043600/files/intensities.zip", "data/steinbock/intensities.zip")
unzip("data/steinbock/intensities.zip", exdir="data/steinbock", overwrite=TRUE)
unlink("data/steinbock/intensities.zip")

# download regionprops
download.file("https://zenodo.org/record/6043600/files/regionprops.zip", "data/steinbock/regionprops.zip")
unzip("data/steinbock/regionprops.zip", exdir="data/steinbock", overwrite=TRUE)
unlink("data/steinbock/regionprops.zip")

# download neighbors
download.file("https://zenodo.org/record/6043600/files/neighbors.zip", "data/steinbock/neighbors.zip")
unzip("data/steinbock/neighbors.zip", exdir="data/steinbock", overwrite=TRUE)
unlink("data/steinbock/neighbors.zip")

# download images
download.file("https://zenodo.org/record/6043600/files/img.zip", "data/steinbock/img.zip")
unzip("data/steinbock/img.zip", exdir="data/steinbock", overwrite=TRUE)
unlink("data/steinbock/img.zip")

# download masks
download.file("https://zenodo.org/record/6043600/files/masks_deepcell.zip", "data/steinbock/masks_deepcell.zip")
unzip("data/steinbock/masks_deepcell.zip", exdir="data/steinbock", overwrite=TRUE)
unlink("data/steinbock/masks_deepcell.zip")

# download individual files
download.file("https://zenodo.org/record/6043600/files/panel.csv", "data/steinbock/panel.csv")
download.file("https://zenodo.org/record/6043600/files/images.csv", "data/steinbock/images.csv")
download.file("https://zenodo.org/record/6043600/files/images.csv", "data/steinbock/steinbock.sh")
```
...
download.file("https://zenodo.org/record/5949116/files/compensation.zip", "data/compensation.zip")
