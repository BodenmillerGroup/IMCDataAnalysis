...
# for some reason GA doesn't download the intensity files
# That's why we download them twice
...
```{r steinbock-results, eval=FALSE}
# download intensities
url <- "https://zenodo.org/record/6043600/files/intensities.zip"
destfile <- "data/steinbock/intensities.zip"
download.file(url, destfile)
...
```{r download-spillover-data, eval=FALSE}
