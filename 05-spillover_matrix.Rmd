...
- Prepare 2% agarose in double distilled H2O in a beaker and melt it in a microwave until well dissolved. 
...
- Pipette 0.3 ul spots of 4% trypan blue dye into an array on the slide. Prepare one spot per antibody, and make sure the spots are well separated. 
...
- Create a panorama across all the spots to visualise their locations.
