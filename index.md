...
author: "**Authors:** Nils Eling [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS)<sup>, Vito Zanotelli [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS), Michelle Daniel [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS), Daniel Schulz [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS),</sup>[<sup>*</sup>](#email), Jonas Windhager [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS), Lasse Meyer [<sup>1</sup>](#DQBM)<sup>,</sup>[<sup>2</sup>](#IMHS)"
...
This workflow has been actively developed until December 2023 and is regularly
updated. For updates, please see the changelog \@ref(changelog). At that time we
used the most recent (`v.0.16.0`) version of `steinbock` to process the example
data. If you are having issues when using newer versions of `steinbock` please
open an issue
[here](https://github.com/BodenmillerGroup/IMCDataAnalysis/issues).
...
<p><strong>Version 1.0.4</strong> [2026-01-06]</p>
<ul>
<li>Updated Introduction about new generation of IMC instruments</li>
<li>Brief introduction to HR-IMC</li>
<li>updated spatial analysis</li>
</ul>
...
<a name="email"><sup>*</sup></a>daniel.schulz@uzh.ch  
