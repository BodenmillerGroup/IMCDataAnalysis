...
expect_equal(table(spe$celltype), 
             structure(c(Bcell = 1594L, BnTcell = 2674L, CD4 = 3861L, CD8 = 3503L, 
Myeloid = 8030L, Neutrophil = 673L, Plasma_cell = 3407L, Stroma = 5303L, 
Treg = 1521L, Tumor = 16630L, undefined = 598L), dim = 11L, dimnames = structure(list(
    c("Bcell", "BnTcell", "CD4", "CD8", "Myeloid", "Neutrophil", 
