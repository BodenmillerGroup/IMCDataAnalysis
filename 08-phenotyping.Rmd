...
on ground truth labeling and random forest classification. 
...
label.files <- list.files("/Volumes/projects/IMCWorkflow/Robjects/gated_cells/", 
...
# Visualize number of cells labelled per patient
table(cur_sce$cytomapper_CellLabel, cur_sce$patient_id)
