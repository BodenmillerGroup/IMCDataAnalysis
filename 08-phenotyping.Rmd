...
cluster 15 (a tumor cluster) is perfectly captured by SNN cluster 12. On the
other hand, another tumor cluster (SNN cluster 1) is split into Rphenograph
cluster 1 and Rphenograph cluster 11. A common approach is to now merge clusters
that contain similar cell types and annotate them by hand.
