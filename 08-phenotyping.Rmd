...
T cells is not possible. The exact gating scheme can be seen at [img/Gating_scheme.pdf](img/Gating_scheme.pdf).

As a related approach, [Astir](https://github.com/camlab-bioml/astir) and [Garnett](https://cole-trapnell-lab.github.io/garnett/) use pre-defined panel information
...
The labelled cells for this data set can be accessed at [zenodo.org/record/6554611](https://zenodo.org/record/6554611) and were
...
forest classifier due to low number of parameters, speed and an observed high
performance for cell type classification [@Hoch2022].
