...
We observe that Patient4 and Patient2 are most similar with lowest batch effect.
The percentage of lost variance is also minimal when merging cells of these
patients. Merging cells of Patient3 into the combined batch of Patient1,
...
cells can be detected, similar to `fastMNN`. 
