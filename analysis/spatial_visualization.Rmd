...
color_vector[c("neutrophil", "macrophage", "otherimmune", "naiveTc")] <- "pink"
...
color_vector[c("Tc")] <- "aquamarine3"
color_vector[c("Th")] <- "coral4"
color_vector[c("unknown")] <- "gray"
color_vector[c("B")] <- "firebrick4"

plotSpatial(cur_images, img_id = "ImageFullName", 
            node_color_by = "CellType", node_size_fix = 0.5) + 
